...
These models are available in the artifacts provided by the authors of DeepCrime paper at the following links:
...
To run DeepMetis for some other mutant, copy the `h5` files of that mutant to the folder `DeepMetis-MNIST/mutant_models`. 
