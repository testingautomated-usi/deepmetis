...
* Run the Sikulix IDE in [Sikulix_jars/sikulixide-2.0.5.jar](Sikulix_jars/) (you can simply double click on it). It will automatically install the Jython standalone version.
